...
const Silider = () => {
    ...
    const sliderData = [
        {
            image: "https://thedealsguru.com/wp-content/uploads/2020/04/Printed-Mobile-Phone-Cases-and-Covers.jpg",
            prev: 3,
            id: 1,
            next: 2
        },
        ...
        {
            image: "https://i.ytimg.com/vi/8i0LcME518g/maxresdefault.jpg",
            prev: 2,
            id: 3,
            next: 1
        }
            ...
            >
                <div class="mx-auto">
                    <div class="flex flex-col-reverse justify-center lg:flex-row">
                        <div class="">
                            <img
                                src="https://thedealsguru.com/wp-content/uploads/2020/04/Printed-Mobile-Phone-Cases-and-Covers.jpg"
                        ...
                        <div class="bg-gray-800 h-auto">
                            <div class="px-4 lg:py-10 md:py-10 py-6">
                                ...
                                <p
                                    class="md:text-4xl text-3xl font-semibold leading-9 text-center text-white py-3"
                                >
                                    WelCome To Phone Retailer

                                </p>
                                <p class="text-2xl leading-normal text-center text-white py-3">
                                    Get up to 20% off
                                </p>
                                <div class="flex justify-center gap-7 pt-3">
                                    ...
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <g clip-path="url(#clip0_2854_2865)">
                                            <path
                                    ...
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <g clip-path="url(#clip0_2854_2885)">
                                            <path
